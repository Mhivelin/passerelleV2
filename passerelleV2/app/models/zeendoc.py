...
class Zeendoc:
    ...
    def getright(self):
        ...
        try:
            ...
            if response.status_code != 200:
                print("Erreur de requête : Code de statut HTTP", response.status_code)
                return None
            ...
            try:
                ...
                try:
                    ...
                    print("Erreur lors de la conversion du JSON en dictionnaire")
                    return None
    ...
    def get_classeurs(self):
        ...
        for collection in right:
            ...
            collections.append({'Coll_Id': collection['Coll_Id'], 'Label': collection['Label']})
    ...
    def searchDocBycustom(self, index_id, index_value, save_query_name="", Wanted_Columns=""):
