...
class EBP:
    ...
    def getPaidPurchaseDocument(self, folder_id, SysModifiedDate="1999-01-01"):
        ...
        url = "https://api-developpeurs.ebp.com/gescom/api/v1/Folders/" + folder_id + "/Documents/PurchaseDocument?Duration=30&DocumentType=null&ToDate=1999-01-01&SysModifiedDate=" + SysModifiedDate + \
