...
class EBP:
    """
    Represents an EBP client.
    
    Attributes:
        idDB (int): The client's ID in the database.
        client_id (str): The client's ID.
        client_secret (str): The client's secret.
        ebp_subscription_key (str): The EBP subscription key.
        ebp_folder_id (str): The EBP folder ID.
        token (dict): The token.
    """
    ...
    def getPaidPurchaseDocument(self, folder_id, SysModifiedDate="1999-01-01"):
        ...
        url = (
            "https://api-developpeurs.ebp.com/gescom/api/v1/Folders/" +
            folder_id +
            "/Documents/PurchaseDocument?Duration=30&DocumentType=null&ToDate=1999-01-01&SysModifiedDate="
            + SysModifiedDate +
            "&Columns=DocumentNumber, Reference, CommitmentsBalanceDue&WhereCondition=%20%20type%3A%20CustomFilter%0A%20%20column%3A%20CommitmentsBalanceDue%0A%20%20operator%3A%20Equal%0A%20%20valueType%20%3A%20Decimal%0A%20%20value%3A%0A%20%20-%200"
        )
