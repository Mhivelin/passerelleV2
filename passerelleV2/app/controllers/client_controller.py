...
def update_client():
    ...
    client.update_client(username, LastUpdate, EBP_CLIENT_ID, EBP_CLIENT_SECRET, EBP_SUBSCRIPTION_KEY, EBP_FOLDER_ID, ZEENDOC_LOGIN, ZEENDOC_URLCLIENT, ZEENDOC_CLASSEUR, ZEENDOC_CPASSWORD)
