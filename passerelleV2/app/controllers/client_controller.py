...
@client_bp.route("/form_add_passerelle", methods=["GET"])
@login_required
def form_add_passerelle():
    logiciels = database.get_all_logiciels()
    return render_template("add_passerelle.html", logiciels=logiciels)

@client_bp.route("/form_add_logiciel", methods=["GET"])
@login_required
def form_add_logiciel():
    return render_template("add_logiciel.html")

@client_bp.route("/form_connect_passerelle", methods=["GET"])
@login_required
def form_connect_passerelle():
    ...
    client =  database.get_client_by_id(idClient)
    return render_template("connect_passerelle.html", passerelles=passerelles, idClient=idClient, client=client)
